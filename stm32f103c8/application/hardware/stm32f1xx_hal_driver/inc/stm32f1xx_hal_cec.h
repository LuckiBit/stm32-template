...
#define __HAL_CEC_ENABLE_IT(__HANDLE__, __INTERRUPT__)                                             \
    SET_BIT((__HANDLE__)->Instance->CFGR, (__INTERRUPT__))
...
#define __HAL_CEC_DISABLE_IT(__HANDLE__, __INTERRUPT__)                                            \
    CLEAR_BIT((__HANDLE__)->Instance->CFGR, (__INTERRUPT__))
...
#define __HAL_CEC_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__)                                         \
    READ_BIT((__HANDLE__)->Instance->CFGR, (__INTERRUPT__))
...
#define __HAL_CEC_GET_TRANSMISSION_START_FLAG(__HANDLE__)                                          \
    READ_BIT((__HANDLE__)->Instance->CSR, CEC_CSR_TSOM)
...
#define __HAL_CEC_GET_TRANSMISSION_END_FLAG(__HANDLE__)                                            \
    READ_BIT((__HANDLE__)->Instance->CSR, CEC_CSR_TEOM)
...
#define __HAL_CEC_SET_OAR(__HANDLE__, __ADDRESS__)                                                 \
    MODIFY_REG((__HANDLE__)->Instance->OAR, CEC_OAR_OA, (__ADDRESS__));
...
#define IS_CEC_BIT_TIMING_ERROR_MODE(MODE)                                                         \
    (((MODE) == CEC_BIT_TIMING_ERROR_MODE_STANDARD) ||                                             \
