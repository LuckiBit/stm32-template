...
#define LL_GPIO_ReadReg(__INSTANCE__, __REG__) READ_REG(__INSTANCE__->__REG__)
     ...
     * @brief This section propose definition to remap the alternate function to some other
     * port/pins.
     * @{
     */
    ...
    __STATIC_INLINE void LL_GPIO_AF_EnableRemap_USART3(void)
    {
        MODIFY_REG(AFIO->MAPR,
                   (AFIO_MAPR_USART3_REMAP | AFIO_MAPR_SWJ_CFG),
    ...
    {
        MODIFY_REG(AFIO->MAPR,
                   (AFIO_MAPR_TIM1_REMAP | AFIO_MAPR_SWJ_CFG),
    ...
    /**
     * @brief Enable the remapping of TIM2 alternate function channels 1 to 4 and external trigger
     * (ETR)
    ...
    {
        MODIFY_REG(AFIO->MAPR,
                   (AFIO_MAPR_TIM2_REMAP | AFIO_MAPR_SWJ_CFG),
    ...
    {
        MODIFY_REG(AFIO->MAPR,
                   (AFIO_MAPR_TIM3_REMAP | AFIO_MAPR_SWJ_CFG),
    ...
    {
        MODIFY_REG(AFIO->MAPR,
                   (AFIO_MAPR_CAN_REMAP | AFIO_MAPR_SWJ_CFG),
     ...
     *        OSC_OUT. This is available only on 36, 48 and 64 pins packages (PD0 and PD1 are
     * available on 100-pin and 144-pin packages, no need for remapping).
    ...
    {
        MODIFY_REG(AFIO->MAPR,
                   (AFIO_MAPR_ADC1_ETRGINJ_REMAP | AFIO_MAPR_SWJ_CFG),
                   AFIO_MAPR_SWJ_CFG);
    }
    ...
    {
        MODIFY_REG(AFIO->MAPR,
                   (AFIO_MAPR_ADC1_ETRGREG_REMAP | AFIO_MAPR_SWJ_CFG),
                   AFIO_MAPR_SWJ_CFG);
    }
    ...
    {
        MODIFY_REG(AFIO->MAPR,
                   (AFIO_MAPR_ADC2_ETRGINJ_REMAP | AFIO_MAPR_SWJ_CFG),
                   AFIO_MAPR_SWJ_CFG);
    }
    ...
    {
        MODIFY_REG(AFIO->MAPR,
                   (AFIO_MAPR_ADC2_ETRGREG_REMAP | AFIO_MAPR_SWJ_CFG),
                   AFIO_MAPR_SWJ_CFG);
    }
     ...
     * @note  ENABLE: DMA2 channel 5 interrupt is mapped separately at position 60 and TIM15 TRGO
     * event is selected as DAC Trigger 3, TIM15 triggers TIM1/3.
     * @note  This bit is available only in high density value line devices.
     * @retval None
     */
     ...
     * @note  DISABLE: DMA2 channel 5 interrupt is mapped with DMA2 channel 4 at position 59, TIM5
     * TRGO event is selected as DAC Trigger 3, TIM5 triggers TIM1/3.
     * @note  This bit is available only in high density value line devices.
     * @retval None
     */
    ...
    {
        MODIFY_REG(AFIO->EVCR,
                   (AFIO_EVCR_PORT) | (AFIO_EVCR_PIN),
