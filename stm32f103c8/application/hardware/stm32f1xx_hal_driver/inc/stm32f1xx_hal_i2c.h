...
#include "stm32f1xx_hal_def.h"
     ...
     * called) b4     (not used) x  : Should be set to 0 b3 0  : Ready or Busy (No Listen mode
     * ongoing) 1  : Listen (Peripheral in Address Listen Mode) b2     Intrinsic process state 0  :
     * Ready 1  : Busy (Peripheral busy with some configuration or internal operations) b1     Rx
     * state 0  : Ready (no Rx operation ongoing) 1  : Busy (Rx operation ongoing) b0     Tx state
