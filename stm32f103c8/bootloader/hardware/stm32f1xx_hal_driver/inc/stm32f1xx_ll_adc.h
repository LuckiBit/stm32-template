...
#define ADC_CHANNEL_ID_INTERNAL_CH_2                                                               \
    0x40000000U /* Marker of internal channel for other ADC instances, in case of different ADC    \
        ...
        uint32_t
            TriggerSource; /*!< Set ADC group regular conversion trigger source: internal (SW start)
                              ...
                              parameter can be a value of @ref ADC_LL_EC_REG_TRIGGER_SOURCE
                                @note On this STM32 series, external trigger is set with trigger
                              polarity: rising edge (only trigger polarity available on this STM32
                              series).
...
#define LL_ADC_FLAG_EOS                                                                            \
    ADC_SR_EOC /*!< ADC flag ADC group regular end of sequence conversions (Note: on this STM32    \
                  series, there is no flag ADC group regular end of unitary conversion. Flag noted \
                  as "EOC" is corresponding to flag "EOS" in other STM32 families) */
...
#define LL_ADC_FLAG_EOS_MST                                                                        \
    ADC_SR_EOC /*!< ADC flag ADC multimode master group regular end of sequence conversions (Note: \
                  on this STM32 series, there is no flag ADC group regular end of unitary          \
                  conversion. Flag noted as "EOC" is corresponding to flag "EOS" in other STM32    \
                  families) */
#define LL_ADC_FLAG_EOS_SLV                                                                        \
    ADC_SR_EOC /*!< ADC flag ADC multimode slave group regular end of sequence conversions (Note:  \
                  on this STM32 series, there is no flag ADC group regular end of unitary          \
                  conversion. Flag noted as "EOC" is corresponding to flag "EOS" in other STM32    \
                  families) (on STM32F1, this flag must be read from ADC instance slave: ADC2) */
#define LL_ADC_FLAG_JEOS_MST                                                                       \
    ADC_SR_JEOC /*!< ADC flag ADC multimode master group injected end of sequence conversions      \
                   (Note: on this STM32 series, there is no flag ADC group injected end of unitary \
                   conversion. Flag noted as "JEOC" is corresponding to flag "JEOS" in other STM32 \
                   families) */
#define LL_ADC_FLAG_JEOS_SLV                                                                       \
    ADC_SR_JEOC /*!< ADC flag ADC multimode slave group injected end of sequence conversions       \
                   (Note: on this STM32 series, there is no flag ADC group injected end of unitary \
                   conversion. Flag noted as "JEOC" is corresponding to flag "JEOS" in other STM32 \
                   families) (on STM32F1, this flag must be read from ADC instance slave: ADC2) */
#define LL_ADC_FLAG_AWD1_MST                                                                       \
    ADC_SR_AWD /*!< ADC flag ADC multimode master analog watchdog 1 of the ADC master */
#define LL_ADC_FLAG_AWD1_SLV                                                                       \
    ADC_SR_AWD /*!< ADC flag ADC multimode slave analog watchdog 1 of the ADC slave (on STM32F1,   \
                  this flag must be read from ADC instance slave: ADC2) */
#endif
/**
 * @}
 */
...
#define LL_ADC_IT_EOS                                                                              \
    ADC_CR1_EOCIE /*!< ADC interruption ADC group regular end of sequence conversions (Note: on    \
                     this STM32 series, there is no flag ADC group regular end of unitary          \
                     conversion. Flag noted as "EOC" is corresponding to flag "EOS" in other STM32 \
                     families) */
...
#define LL_ADC_DMA_REG_REGULAR_DATA                                                                \
    0x00000000U /* ADC group regular conversion data register (corresponding to register DR) to be \
                   used with ADC configured in independent mode. Without DMA transfer, register    \
                   accessed by LL function @ref LL_ADC_REG_ReadConversionData32() and other        \
                   functions @ref LL_ADC_REG_ReadConversionDatax() */
#if defined(ADC_MULTIMODE_SUPPORT)
#define LL_ADC_DMA_REG_REGULAR_DATA_MULTI                                                          \
    0x00000001U /* ADC group regular conversion data register (corresponding to register CDR) to   \
...
#define LL_ADC_PATH_INTERNAL_VREFINT                                                               \
    (ADC_CR2_TSVREFE) /*!< ADC measurement path to internal channel VrefInt */
...
#define LL_ADC_DATA_ALIGN_RIGHT                                                                    \
    0x00000000U /*!< ADC conversion data alignment: right aligned (alignment on data register LSB  \
                   bit 0)*/
...
#define LL_ADC_CHANNEL_VREFINT                                                                     \
    (LL_ADC_CHANNEL_17 |                                                                           \
     ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to VrefInt: Internal voltage  \
                                    reference. On STM32F1, ADC channel available only on ADC       \
                                    instance: ADC1. */
#define LL_ADC_CHANNEL_TEMPSENSOR                                                                  \
    (LL_ADC_CHANNEL_16 |                                                                           \
     ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to Temperature sensor. */
/**
 * @}
 */
 ...
 * @{
 */
/* ADC group regular external triggers for ADC instances: ADC1, ADC2, ADC3 (for ADC instances ADCx
...
#define LL_ADC_REG_TRIG_EXT_TIM1_CH3                                                               \
    (ADC_CR2_EXTSEL_1) /*!< ADC group regular conversion trigger from external IP: TIM1 channel 3  \
                          event (capture compare: input capture or output capture). Trigger edge   \
                          set to rising edge (default setting). */
/* ADC group regular external triggers for ADC instances: ADC1, ADC2 (for ADC instances ADCx
 * available on the selected device) */
#define LL_ADC_REG_TRIG_EXT_TIM1_CH1                                                               \
    0x00000000U /*!< ADC group regular conversion trigger from external IP: TIM1 channel 1 event   \
...
#define LL_ADC_REG_TRIG_EXT_TIM1_CH2                                                               \
    (ADC_CR2_EXTSEL_0) /*!< ADC group regular conversion trigger from external IP: TIM1 channel 2  \
                          event (capture compare: input capture or output capture). Trigger edge   \
                          set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM2_CH2                                                               \
    (ADC_CR2_EXTSEL_1 |                                                                            \
     ADC_CR2_EXTSEL_0) /*!< ADC group regular conversion trigger from external IP: TIM2 channel 2  \
                          event (capture compare: input capture or output capture). Trigger edge   \
                          set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM3_TRGO                                                              \
    (ADC_CR2_EXTSEL_2) /*!< ADC group regular conversion trigger from external IP: TIM3 TRGO.      \
                          Trigger edge set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_TIM4_CH4                                                               \
    (ADC_CR2_EXTSEL_2 |                                                                            \
     ADC_CR2_EXTSEL_0) /*!< ADC group regular conversion trigger from external IP: TIM4 channel 4  \
                          event (capture compare: input capture or output capture). Trigger edge   \
                          set to rising edge (default setting). */
#define LL_ADC_REG_TRIG_EXT_EXTI_LINE11                                                            \
    (ADC_CR2_EXTSEL_2 |                                                                            \
     ADC_CR2_EXTSEL_1) /*!< ADC group regular conversion trigger from external IP: external        \
...
#define LL_ADC_REG_TRIG_EXT_TIM8_TRGO                                                              \
    (LL_ADC_REG_TRIG_EXT_EXTI_LINE11) /*!< ADC group regular conversion trigger from external IP:  \
                                         TIM8 TRGO. Trigger edge set to rising edge (default       \
                                         setting). Available only on high-density and XL-density   \
                                         devices. A remap of trigger must be done at top level     \
                                         (refer to AFIO peripheral).*/
#endif /* STM32F101xE || STM32F103xE || STM32F103xG || STM32F105xC || STM32F107xC */
#if defined(STM32F103xE) || defined(STM32F103xG)
/* ADC group regular external triggers for ADC instances: ADC3 (for ADC instances ADCx available on
 * the selected device) */
#define LL_ADC_REG_TRIG_EXT_TIM3_CH1                                                               \
    (LL_ADC_REG_TRIG_EXT_TIM1_CH1) /*!< ADC group regular conversion trigger from external IP:     \
...
#define LL_ADC_REG_TRIG_EXT_TIM2_CH3                                                               \
    (LL_ADC_REG_TRIG_EXT_TIM1_CH2) /*!< ADC group regular conversion trigger from external IP:     \
                                      TIM2 channel 3 event (capture compare: input capture or      \
                                      output capture). Trigger edge set to rising edge (default    \
                                      setting). */
#define LL_ADC_REG_TRIG_EXT_TIM8_CH1                                                               \
    (LL_ADC_REG_TRIG_EXT_TIM2_CH2) /*!< ADC group regular conversion trigger from external IP:     \
                                      TIM8 channel 1 event (capture compare: input capture or      \
                                      output capture). Trigger edge set to rising edge (default    \
                                      setting). */
#define LL_ADC_REG_TRIG_EXT_TIM8_TRGO_ADC3                                                         \
    (LL_ADC_REG_TRIG_EXT_TIM3_TRGO) /*!< ADC group regular conversion trigger from external IP:    \
                                       TIM8 TRGO. Trigger edge set to rising edge (default         \
                                       setting). */
#define LL_ADC_REG_TRIG_EXT_TIM5_CH1                                                               \
    (LL_ADC_REG_TRIG_EXT_TIM4_CH4) /*!< ADC group regular conversion trigger from external IP:     \
...
#define LL_ADC_REG_DMA_TRANSFER_UNLIMITED                                                          \
    (ADC_CR2_DMA) /*!< ADC conversion data are transferred by DMA, in unlimited mode: DMA transfer \
                     requests are unlimited, whatever number of DMA data transferred (number of    \
                     ADC conversions). This ADC mode is intended to be used with DMA mode          \
                     circular. */
/**
 * @}
 */
...
#define LL_ADC_REG_SEQ_SCAN_DISABLE                                                                \
    0x00000000U /*!< ADC group regular sequencer disable (equivalent to sequencer of 1 rank: ADC   \
 ...
 * @{
 */
/* ADC group injected external triggers for ADC instances: ADC1, ADC2, ADC3 (for ADC instances ADCx
 * available on the selected device) */
...
#define LL_ADC_INJ_TRIG_EXT_TIM1_TRGO                                                              \
    0x00000000U /*!< ADC group injected conversion trigger from external IP: TIM1 TRGO. Trigger    \
                   edge set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM1_CH4                                                               \
    (ADC_CR2_JEXTSEL_0) /*!< ADC group injected conversion trigger from external IP: TIM1 channel  \
                           4 event (capture compare: input capture or output capture). Trigger     \
                           edge set to rising edge (default setting). */
/* ADC group injected external triggers for ADC instances: ADC1, ADC2 (for ADC instances ADCx
 * available on the selected device) */
#define LL_ADC_INJ_TRIG_EXT_TIM2_TRGO                                                              \
    (ADC_CR2_JEXTSEL_1) /*!< ADC group injected conversion trigger from external IP: TIM2 TRGO.    \
                           Trigger edge set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM2_CH1                                                               \
    (ADC_CR2_JEXTSEL_1 |                                                                           \
     ADC_CR2_JEXTSEL_0) /*!< ADC group injected conversion trigger from external IP: TIM2 channel  \
                           1 event (capture compare: input capture or output capture). Trigger     \
                           edge set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM3_CH4                                                               \
    (ADC_CR2_JEXTSEL_2) /*!< ADC group injected conversion trigger from external IP: TIM3 channel  \
                           4 event (capture compare: input capture or output capture). Trigger     \
                           edge set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM4_TRGO                                                              \
    (ADC_CR2_JEXTSEL_2 |                                                                           \
     ADC_CR2_JEXTSEL_0) /*!< ADC group injected conversion trigger from external IP: TIM4 TRGO.    \
                           Trigger edge set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_EXTI_LINE15                                                            \
    (ADC_CR2_JEXTSEL_2 | ADC_CR2_JEXTSEL_1) /*!< ADC group injected conversion trigger from        \
...
#define LL_ADC_INJ_TRIG_EXT_TIM8_CH4                                                               \
    (LL_ADC_INJ_TRIG_EXT_EXTI_LINE15) /*!< ADC group injected conversion trigger from external IP: \
...
#endif /* STM32F101xE || STM32F103xE || STM32F103xG || STM32F105xC || STM32F107xC */
#if defined(STM32F103xE) || defined(STM32F103xG)
/* ADC group injected external triggers for ADC instances: ADC3 (for ADC instances ADCx available on
 * the selected device) */
#define LL_ADC_INJ_TRIG_EXT_TIM4_CH3                                                               \
    (LL_ADC_INJ_TRIG_EXT_TIM2_TRGO) /*!< ADC group injected conversion trigger from external IP:   \
                                       TIM4 channel 3 event (capture compare: input capture or     \
                                       output capture). Trigger edge set to rising edge (default   \
                                       setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM8_CH2                                                               \
    (LL_ADC_INJ_TRIG_EXT_TIM2_CH1) /*!< ADC group injected conversion trigger from external IP:    \
                                      TIM8 channel 2 event (capture compare: input capture or      \
                                      output capture). Trigger edge set to rising edge (default    \
                                      setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM8_CH4_ADC3                                                          \
    (LL_ADC_INJ_TRIG_EXT_TIM3_CH4) /*!< ADC group injected conversion trigger from external IP:    \
                                      TIM8 channel 4 event (capture compare: input capture or      \
                                      output capture). Trigger edge set to rising edge (default    \
                                      setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM5_TRGO                                                              \
    (LL_ADC_INJ_TRIG_EXT_TIM4_TRGO) /*!< ADC group injected conversion trigger from external IP:   \
...
#define LL_ADC_INJ_TRIG_INDEPENDENT                                                                \
    0x00000000U /*!< ADC group injected conversion trigger independent. Setting mandatory if ADC   \
...
#define LL_ADC_INJ_SEQ_SCAN_DISABLE                                                                \
    0x00000000U /*!< ADC group injected sequencer disable (equivalent to sequencer of 1 rank: ADC  \
                   conversion on only 1 channel) */
...
#define LL_ADC_SAMPLINGTIME_13CYCLES_5                                                             \
    (ADC_SMPR2_SMP0_1) /*!< Sampling time 13.5 ADC clock cycles */
...
#define LL_ADC_SAMPLINGTIME_41CYCLES_5                                                             \
    (ADC_SMPR2_SMP0_2) /*!< Sampling time 41.5 ADC clock cycles */
...
#define LL_ADC_SAMPLINGTIME_239CYCLES_5                                                            \
    (ADC_SMPR2_SMP0_2 | ADC_SMPR2_SMP0_1 |                                                         \
     ADC_SMPR2_SMP0_0) /*!< Sampling time 239.5 ADC clock cycles */
/**
 * @}
 */
...
#define LL_ADC_MULTI_DUAL_REG_SIMULT                                                               \
    (ADC_CR1_DUALMOD_2 |                                                                           \
     ADC_CR1_DUALMOD_1) /*!< ADC dual mode enabled: group regular simultaneous */
#define LL_ADC_MULTI_DUAL_REG_INTERL_FAST                                                          \
    (ADC_CR1_DUALMOD_2 | ADC_CR1_DUALMOD_1 |                                                       \
     ADC_CR1_DUALMOD_0) /*!< ADC dual mode enabled: Combined group regular interleaved fast (delay \
                           between ADC sampling phases: 7 ADC clock cycles) (equivalent to         \
                           multimode sampling delay set to "LL_ADC_MULTI_TWOSMP_DELAY_7CYCLES" on  \
                           other STM32 devices)) */
#define LL_ADC_MULTI_DUAL_REG_INTERL_SLOW                                                          \
    (ADC_CR1_DUALMOD_3) /*!< ADC dual mode enabled: Combined group regular interleaved slow (delay \
                           between ADC sampling phases: 14 ADC clock cycles) (equivalent to        \
                           multimode sampling delay set to "LL_ADC_MULTI_TWOSMP_DELAY_14CYCLES" on \
                           other STM32 devices)) */
#define LL_ADC_MULTI_DUAL_INJ_SIMULT                                                               \
    (ADC_CR1_DUALMOD_2 |                                                                           \
     ADC_CR1_DUALMOD_0) /*!< ADC dual mode enabled: group injected simultaneous slow (delay        \
                           between ADC sampling phases: 14 ADC clock cycles) (equivalent to        \
                           multimode sampling delay set to "LL_ADC_MULTI_TWOSMP_DELAY_14CYCLES" on \
                           other STM32 devices)) */
#define LL_ADC_MULTI_DUAL_INJ_ALTERN                                                               \
    (ADC_CR1_DUALMOD_3 |                                                                           \
     ADC_CR1_DUALMOD_0) /*!< ADC dual mode enabled: group injected alternate trigger. Works only   \
                           with external triggers (not internal SW start) */
#define LL_ADC_MULTI_DUAL_REG_SIM_INJ_SIM                                                          \
    (ADC_CR1_DUALMOD_0) /*!< ADC dual mode enabled: Combined group regular simultaneous + group    \
                           injected simultaneous */
#define LL_ADC_MULTI_DUAL_REG_SIM_INJ_ALT                                                          \
    (ADC_CR1_DUALMOD_1) /*!< ADC dual mode enabled: Combined group regular simultaneous + group    \
                           injected alternate trigger */
#define LL_ADC_MULTI_DUAL_REG_INTFAST_INJ_SIM                                                      \
    (ADC_CR1_DUALMOD_1 |                                                                           \
     ADC_CR1_DUALMOD_0) /*!< ADC dual mode enabled: Combined group regular interleaved fast (delay \
                           between ADC sampling phases: 7 ADC clock cycles) + group injected       \
                           simultaneous */
#define LL_ADC_MULTI_DUAL_REG_INTSLOW_INJ_SIM                                                      \
    (ADC_CR1_DUALMOD_2) /*!< ADC dual mode enabled: Combined group regular interleaved slow (delay \
                           between ADC sampling phases: 14 ADC clock cycles) + group injected      \
                           simultaneous */
...
#define LL_ADC_MULTI_MASTER                                                                        \
    (ADC_DR_DATA) /*!< In multimode, selection among several ADC instances: ADC master */
#define LL_ADC_MULTI_SLAVE                                                                         \
    (ADC_DR_ADC2DATA) /*!< In multimode, selection among several ADC instances: ADC slave */
#define LL_ADC_MULTI_MASTER_SLAVE                                                                  \
    (ADC_DR_ADC2DATA | ADC_DR_DATA) /*!< In multimode, selection among several ADC instances: both \
...
#define __LL_ADC_IS_CHANNEL_INTERNAL_AVAILABLE(__ADC_INSTANCE__, __CHANNEL__)                      \
    (((__ADC_INSTANCE__) == ADC1) ? (((__CHANNEL__) == LL_ADC_CHANNEL_VREFINT) ||                  \
...
#define __LL_ADC_COMMON_INSTANCE(__ADCx__)                                                         \
    ((((__ADCx__) == ADC1) || ((__ADCx__) == ADC2)) ? ((ADC12_COMMON)) : ((0U)))
 ...
 * value (unit: uV/DegCelsius). On STM32F1, refer to device datasheet parameter "Avg_Slope".
 * @param  __TEMPSENSOR_TYP_CALX_V__     Device datasheet data: Temperature sensor voltage typical
 * value (at temperature and Vref+ defined in parameters below) (unit: mV). On STM32F1, refer to
 ...
 */
     ...
     *
     *         (1) On STM32F1, parameter available on all ADC instances: ADC1, ADC2, ADC3 (for ADC
     * instances ADCx available on the selected device).\n (2) On STM32F1, parameter available only
     * on ADC instances: ADC1, ADC2 (for ADC instances ADCx available on the selected device).\n (3)
     * On STM32F1, parameter available only on ADC instances: ADC3 (for ADC instances ADCx available
     ...
     */
    __STATIC_INLINE void
    LL_ADC_INJ_SetOffset(ADC_TypeDef *ADCx, uint32_t Rank, uint32_t OffsetLevel)
    {
        __IO uint32_t *preg =
