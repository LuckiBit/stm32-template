...
ErrorStatus LL_ADC_DeInit(ADC_TypeDef *ADCx)
{
    ...
    if(READ_BIT(ADCx->CR2, ADC_CR2_ADON) == 0U)
    {
        ...
        /* Reset register SR */
        CLEAR_BIT(ADCx->SR,
                  (LL_ADC_FLAG_STRT | LL_ADC_FLAG_JSTRT | LL_ADC_FLAG_EOS | LL_ADC_FLAG_JEOS |
                   LL_ADC_FLAG_AWD1));
    ...
    defined(STM32F107xC) || defined(STM32F103xE) || defined(STM32F103xG)
        ...
        CLEAR_BIT(ADCx->CR1,
                  (ADC_CR1_AWDEN | ADC_CR1_JAWDEN | ADC_CR1_DUALMOD | ADC_CR1_DISCNUM |
        ...
        CLEAR_BIT(ADCx->CR1,
                  (ADC_CR1_AWDEN | ADC_CR1_JAWDEN | ADC_CR1_DISCNUM | ADC_CR1_JDISCEN |
        ...
        /* Reset register CR2 */
        CLEAR_BIT(ADCx->CR2,
                  (ADC_CR2_TSVREFE | ADC_CR2_SWSTART | ADC_CR2_EXTTRIG | ADC_CR2_EXTSEL |
                   ADC_CR2_JSWSTART | ADC_CR2_JEXTTRIG | ADC_CR2_JEXTSEL | ADC_CR2_ALIGN |
                   ADC_CR2_DMA | ADC_CR2_RSTCAL | ADC_CR2_CAL | ADC_CR2_CONT | ADC_CR2_ADON));

        /* Reset register SMPR1 */
        CLEAR_BIT(ADCx->SMPR1,
                  (ADC_SMPR1_SMP17 | ADC_SMPR1_SMP16 | ADC_SMPR1_SMP15 | ADC_SMPR1_SMP14 |
        ...
        /* Reset register SQR2 */
        CLEAR_BIT(ADCx->SQR2,
                  (ADC_SQR2_SQ12 | ADC_SQR2_SQ11 | ADC_SQR2_SQ10 | ADC_SQR2_SQ9 | ADC_SQR2_SQ8 |
                   ADC_SQR2_SQ7));

        /* Reset register SQR3 */
        CLEAR_BIT(ADCx->SQR3,
                  (ADC_SQR3_SQ6 | ADC_SQR3_SQ5 | ADC_SQR3_SQ4 | ADC_SQR3_SQ3 | ADC_SQR3_SQ2 |
                   ADC_SQR3_SQ1));
...
ErrorStatus LL_ADC_REG_Init(ADC_TypeDef *ADCx, LL_ADC_REG_InitTypeDef *ADC_REG_InitStruct)
{
    ...
    if(LL_ADC_IsEnabled(ADCx) == 0U)
    {
        ...
        MODIFY_REG(ADCx->CR2,
                   ADC_CR2_EXTSEL | ADC_CR2_CONT | ADC_CR2_DMA,
