...
#define IS_RCC_PLL_MUL(__MUL__)                                                                    \
    (((__MUL__) == RCC_PLL_MUL2) || ((__MUL__) == RCC_PLL_MUL3) || ((__MUL__) == RCC_PLL_MUL4) ||  \
     ...
     ((__MUL__) == RCC_PLL_MUL11) || ((__MUL__) == RCC_PLL_MUL12) ||                               \
     ((__MUL__) == RCC_PLL_MUL13) || ((__MUL__) == RCC_PLL_MUL14) ||                               \
     ((__MUL__) == RCC_PLL_MUL15) || ((__MUL__) == RCC_PLL_MUL16))
...
#define IS_RCC_USBPLLCLK_DIV(__USBCLK__)                                                           \
    ...
    {
        uint32_t
            PLLI2SMUL; /*!< PLLI2SMUL: Multiplication factor for PLLI2S VCO input clock
