...
#include "stm32f1xx_hal_def.h"
    ...
    typedef struct
    {
        ...
        uint32_t WordLength; /*!< Specifies the number of data bits transmitted or received in a
                                frame. This parameter can be a value of @ref IRDA_Word_Length */
        ...
        uint8_t Prescaler; /*!< Specifies the Prescaler value to be programmed
                                in the IrDA low-power Baud Register, for defining pulse width on
                              which burst acceptance/rejection will be decided. This value is used
                              as divisor of system clock to achieve required pulse width. */
...
#define IRDA_DIVFRAQ(_PCLK_, _BAUD_)                                                               \
    ((((IRDA_DIV((_PCLK_), (_BAUD_)) - (IRDA_DIVMANT((_PCLK_), (_BAUD_)) * 100U)) * 16U) + 50U) /  \
     100U)
