    ...
    typedef struct
    {
        uint32_t
            AsynchPrediv; /*!< Specifies the RTC Asynchronous Predivider value.
                             ...
                             = 0xFFFFF  or RTC_AUTO_1_SECOND If RTC_AUTO_1_SECOND is selected,
                             AsynchPrediv will be set automatically to get 1sec timebase */
...
#define RTC_ALARM_A 0U /*!< Specify alarm ID (mainly for legacy purposes) */
    ...
    /** @defgroup RTC_output_source_to_output_on_the_Tamper_pin Output source to output on the
     * Tamper pin
     * @{
     */

#define RTC_OUTPUTSOURCE_NONE 0x00000000U /*!< No output on the TAMPER pin  */
#define RTC_OUTPUTSOURCE_CALIBCLOCK                                                                \
    BKP_RTCCR_CCO /*!< RTC clock with a frequency divided by 64 on the TAMPER pin  */
#define RTC_OUTPUTSOURCE_ALARM BKP_RTCCR_ASOE /*!< Alarm pulse signal on the TAMPER pin  */
#define RTC_OUTPUTSOURCE_SECOND                                                                    \
...
#define __HAL_RTC_WRITEPROTECTION_DISABLE(__HANDLE__)                                              \
    SET_BIT((__HANDLE__)->Instance->CRL, RTC_CRL_CNF)
...
#define __HAL_RTC_WRITEPROTECTION_ENABLE(__HANDLE__)                                               \
    CLEAR_BIT((__HANDLE__)->Instance->CRL, RTC_CRL_CNF)
