...
uint32_t LL_RCC_GetI2SClockFreq(uint32_t I2SxSource)
{
    ...
    switch(LL_RCC_GetI2SClockSource(I2SxSource))
    {
        ...
        case LL_RCC_I2S2_CLKSOURCE_PLLI2S_VCO: /*!< PLLI2S oscillator clock selected as I2S clock
                                                  source */
 ...
 *         @arg @ref LL_RCC_PERIPH_FREQUENCY_NO indicates that oscillator (HSI), HSE or PLL is not
 * ready
 */
...
uint32_t RCC_PLL2_GetFreqClockFreq(void)
{
    return __LL_RCC_CALC_PLL2CLK_FREQ(HSE_VALUE,
...
uint32_t RCC_PLLI2S_GetFreqDomain_I2S(void)
{
    return __LL_RCC_CALC_PLLI2SCLK_FREQ(HSE_VALUE,
