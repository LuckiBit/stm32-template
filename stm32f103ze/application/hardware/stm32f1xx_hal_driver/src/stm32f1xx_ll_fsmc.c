 ...
 */
    ...
    defined(HAL_PCCARD_MODULE_ENABLED) || defined(HAL_SRAM_MODULE_ENABLED)
...
#define BTR_CLEAR_MASK                                                                             \
    ((uint32_t)(FSMC_BTRx_ADDSET | FSMC_BTRx_ADDHLD | FSMC_BTRx_DATAST | FSMC_BTRx_BUSTURN |       \
...
#define BWTR_CLEAR_MASK                                                                            \
    ((uint32_t)(FSMC_BWTRx_ADDSET | FSMC_BWTRx_ADDHLD | FSMC_BWTRx_DATAST | FSMC_BWTRx_BUSTURN |   \
                FSMC_BWTRx_ACCMOD))
#else
#define BWTR_CLEAR_MASK                                                                            \
    ((uint32_t)(FSMC_BWTRx_ADDSET | FSMC_BWTRx_ADDHLD | FSMC_BWTRx_DATAST | FSMC_BWTRx_ACCMOD |    \
...
#define PCR_CLEAR_MASK                                                                             \
    ((uint32_t)(FSMC_PCRx_PWAITEN | FSMC_PCRx_PBKEN | FSMC_PCRx_PTYP | FSMC_PCRx_PWID |            \
                FSMC_PCRx_ECCEN | FSMC_PCRx_TCLR | FSMC_PCRx_TAR | FSMC_PCRx_ECCPS))
/* --- PMEM Register ---*/
/* PMEM register clear mask */
#define PMEM_CLEAR_MASK                                                                            \
    ((uint32_t)(FSMC_PMEMx_MEMSETx | FSMC_PMEMx_MEMWAITx | FSMC_PMEMx_MEMHOLDx |                   \
                FSMC_PMEMx_MEMHIZx))

/* --- PATT Register ---*/
/* PATT register clear mask */
#define PATT_CLEAR_MASK                                                                            \
    ((uint32_t)(FSMC_PATTx_ATTSETx | FSMC_PATTx_ATTWAITx | FSMC_PATTx_ATTHOLDx |                   \
                FSMC_PATTx_ATTHIZx))
...
#define PCR4_CLEAR_MASK                                                                            \
    ((uint32_t)(FSMC_PCR4_PWAITEN | FSMC_PCR4_PBKEN | FSMC_PCR4_PTYP | FSMC_PCR4_PWID |            \
                FSMC_PCR4_ECCEN | FSMC_PCR4_TCLR | FSMC_PCR4_TAR | FSMC_PCR4_ECCPS))
/* --- PMEM Register ---*/
/* PMEM register clear mask */
#define PMEM4_CLEAR_MASK                                                                           \
    ((uint32_t)(FSMC_PMEM4_MEMSET4 | FSMC_PMEM4_MEMWAIT4 | FSMC_PMEM4_MEMHOLD4 |                   \
                FSMC_PMEM4_MEMHIZ4))

/* --- PATT Register ---*/
/* PATT register clear mask */
#define PATT4_CLEAR_MASK                                                                           \
    ((uint32_t)(FSMC_PATT4_ATTSET4 | FSMC_PATT4_ATTWAIT4 | FSMC_PATT4_ATTHOLD4 |                   \
                FSMC_PATT4_ATTHIZ4))

/* --- PIO4 Register ---*/
/* PIO4 register clear mask */
#define PIO4_CLEAR_MASK                                                                            \
    ((uint32_t)(FSMC_PIO4_IOSET4 | FSMC_PIO4_IOWAIT4 | FSMC_PIO4_IOHOLD4 | FSMC_PIO4_IOHIZ4))
...
/** @defgroup FSMC_LL_NORSRAM_Exported_Functions_Group1 Initialization and de-initialization
functions
                                    ...
                                    const FSMC_NORSRAM_InitTypeDef *Init)
{
    ...
    mask = (FSMC_BCRx_MBKEN | FSMC_BCRx_MUXEN | FSMC_BCRx_MTYP | FSMC_BCRx_MWID | FSMC_BCRx_FACCEN |
            FSMC_BCRx_BURSTEN | FSMC_BCRx_WAITPOL | FSMC_BCRx_WAITCFG | FSMC_BCRx_WREN |
            FSMC_BCRx_WAITEN | FSMC_BCRx_EXTMOD | FSMC_BCRx_ASYNCWAIT | FSMC_BCRx_CBURSTRW);
...
HAL_StatusTypeDef FSMC_NORSRAM_Timing_Init(FSMC_NORSRAM_TypeDef             *Device,
                                           const FSMC_NORSRAM_TimingTypeDef *Timing,
                                           uint32_t                          Bank)
{
    ...
    Device->BTCR[Bank + 1U] = (Timing->AddressSetupTime << FSMC_BTRx_ADDSET_Pos) |
...
HAL_StatusTypeDef FSMC_NAND_Init(FSMC_NAND_TypeDef *Device, const FSMC_NAND_InitTypeDef *Init)
{
    ...
    if(Init->NandBank == FSMC_NAND_BANK2)
    {
        ...
        MODIFY_REG(Device->PCR2,
                   PCR_CLEAR_MASK,
                   (Init->Waitfeature | FSMC_PCR_MEMORY_TYPE_NAND | Init->MemoryDataWidth |
 ...
 */
HAL_StatusTypeDef
FSMC_NAND_GetECC(const FSMC_NAND_TypeDef *Device, uint32_t *ECCval, uint32_t Bank, uint32_t Timeout)
{
    uint32_t tickstart;
