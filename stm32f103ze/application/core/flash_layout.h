...
/* Keep these values synchronized with Bootloader's private definition. */
#define MCU_FLASH_BASE_ADDRESS 0x08000000UL
#define MCU_FLASH_SIZE         (512UL * 1024UL)
#define MCU_SRAM_BASE_ADDRESS  0x20000000UL
#define MCU_SRAM_SIZE          (64UL * 1024UL)
