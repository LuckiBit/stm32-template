...
#define IS_FSMC_PAGESIZE(__SIZE__)                                                                 \
    (((__SIZE__) == FSMC_PAGE_SIZE_NONE) || ((__SIZE__) == FSMC_PAGE_SIZE_128) ||                  \
     ((__SIZE__) == FSMC_PAGE_SIZE_256) || ((__SIZE__) == FSMC_PAGE_SIZE_512) ||                   \
...
#define IS_FSMC_CONTINOUS_CLOCK(__CCLOCK__)                                                        \
    (((__CCLOCK__) == FSMC_CONTINUOUS_CLOCK_SYNC_ONLY) ||                                          \
...
#define IS_FSMC_NORSRAM_EXTENDED_DEVICE(__INSTANCE__)                                              \
    ((__INSTANCE__) == FSMC_NORSRAM_EXTENDED_DEVICE)
...
#define IS_FSMC_WAIT_FEATURE(__FEATURE__)                                                          \
    (((__FEATURE__) == FSMC_NAND_PCC_WAIT_FEATURE_DISABLE) ||                                      \
     ((__FEATURE__) == FSMC_NAND_PCC_WAIT_FEATURE_ENABLE))
#define IS_FSMC_NAND_MEMORY_WIDTH(__WIDTH__)                                                       \
    (((__WIDTH__) == FSMC_NAND_PCC_MEM_BUS_WIDTH_8) ||                                             \
     ((__WIDTH__) == FSMC_NAND_PCC_MEM_BUS_WIDTH_16))
#define IS_FSMC_ECC_STATE(__STATE__)                                                               \
    (((__STATE__) == FSMC_NAND_ECC_DISABLE) || ((__STATE__) == FSMC_NAND_ECC_ENABLE))

#define IS_FSMC_ECCPAGE_SIZE(__SIZE__)                                                             \
    (((__SIZE__) == FSMC_NAND_ECC_PAGE_SIZE_256BYTE) ||                                            \
...
#define FSMC_PCCARD_DEVICE FSMC_Bank4
    ...
    typedef struct
    {
        ...
        uint32_t WaitSignalPolarity; /*!< Specifies the wait signal polarity, valid only when
                                        ...
                                        be a value of @ref FSMC_Wait_Signal_Polarity         */
    ...
    {
        uint32_t
            Waitfeature; /*!< Enables or disables the Wait feature for the PCCARD Memory device.
                              This parameter can be any value of @ref FSMC_Wait_feature      */
...
#define __FSMC_NORSRAM_ENABLE(__INSTANCE__, __BANK__)                                              \
    ((__INSTANCE__)->BTCR[(__BANK__)] |= FSMC_BCRx_MBKEN)
 ...
 * @retval None
 */
#define __FSMC_PCCARD_ENABLE_IT(__INSTANCE__, __INTERRUPT__)                                       \
 ...
 */
     ...
     *  @{
     */
    /** @defgroup FSMC_LL_NORSRAM_Private_Functions_Group1 NOR SRAM Initialization/de-initialization
     * functions
     *  @{
     */
     ...
     *  @{
     */
    HAL_StatusTypeDef FSMC_NORSRAM_WriteOperation_Enable(FSMC_NORSRAM_TypeDef *Device,
                                                         uint32_t              Bank);
    HAL_StatusTypeDef FSMC_NORSRAM_WriteOperation_Disable(FSMC_NORSRAM_TypeDef *Device,
                                                          uint32_t              Bank);
/**
 * @}
 */
 ...
 */
     ...
     *  @{
     */
    /** @defgroup FSMC_LL_NAND_Private_Functions_Group1 NAND Initialization/de-initialization
     * functions
     *  @{
     */
    ...
    HAL_StatusTypeDef FSMC_NAND_CommonSpace_Timing_Init(FSMC_NAND_TypeDef                 *Device,
                                                        ...
                                                        uint32_t                           Bank);
    HAL_StatusTypeDef
                      FSMC_NAND_AttributeSpace_Timing_Init(FSMC_NAND_TypeDef                 *Device,
                                                           const FSMC_NAND_PCC_TimingTypeDef *Timing,
                                                           uint32_t                           Bank);
    ...
    HAL_StatusTypeDef FSMC_NAND_GetECC(const FSMC_NAND_TypeDef *Device,
                                       uint32_t                *ECCval,
                                       uint32_t                 Bank,
                                       uint32_t                 Timeout);
/**
 ...
 */
     ...
     *  @{
     */
    /** @defgroup FSMC_LL_PCCARD_Private_Functions_Group1 PCCARD Initialization/de-initialization
     * functions
     *  @{
     */
    ...
    HAL_StatusTypeDef
    FSMC_PCCARD_CommonSpace_Timing_Init(FSMC_PCCARD_TypeDef               *Device,
                                        const FSMC_NAND_PCC_TimingTypeDef *Timing);
    HAL_StatusTypeDef
                      FSMC_PCCARD_AttributeSpace_Timing_Init(FSMC_PCCARD_TypeDef               *Device,
                                                             const FSMC_NAND_PCC_TimingTypeDef *Timing);
