...
HAL_StatusTypeDef HAL_I2C_Init(I2C_HandleTypeDef *hi2c)
{
    ...
    MODIFY_REG(hi2c->Instance->TRISE,
               I2C_TRISE_TRISE,
        ...
        while(hi2c->XferSize > 0U)
        {
            if(hi2c->XferSize <= 3U)
            {
                ...
                else if(hi2c->XferSize == 2U)
                {
                    ...
                    /* Disable all active IRQs around ADDR clearing and STOP programming because the
                       EV6_3 software sequence must complete before the current byte end of transfer
                     */
                    __disable_irq();
                                        ...
                                        uint16_t           Size)
{
    ...
    if(hi2c->State == HAL_I2C_STATE_READY)
    {
        ...
        if(hi2c->XferSize > 0U)
        {
            ...
            {
                /* Send Slave Address and Memory Address */
                if(I2C_RequestMemoryWrite(hi2c,
                                          DevAddress,
                                          MemAddress,
                                          MemAddSize,
                                          I2C_TIMEOUT_FLAG,
