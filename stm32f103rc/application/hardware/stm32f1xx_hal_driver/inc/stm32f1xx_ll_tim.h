...
#define LL_TIM_SLAVEMODE_TRIGGER                                                                   \
    (TIM_SMCR_SMS_2 | TIM_SMCR_SMS_1) /*!< Trigger Mode - The counter starts at a rising edge of   \
                                         the trigger TRGI */
/**
 * @}
 */
...
#define LL_TIM_DMABURST_LENGTH_8TRANSFERS                                                          \
    (TIM_DCR_DBL_2 | TIM_DCR_DBL_1 | TIM_DCR_DBL_0) /*!< Transfer is done to 1 registers starting  \
...
#define __LL_TIM_GET_ICPSC_RATIO(__ICPSC__)                                                        \
     ...
     */
    __STATIC_INLINE void
    LL_TIM_IC_Config(TIM_TypeDef *TIMx, uint32_t Channel, uint32_t Configuration)
    {
        uint8_t        iChannel = TIM_GET_CHANNEL_INDEX(Channel);
        __IO uint32_t *pReg =
            (__IO uint32_t *)((uint32_t)((uint32_t)(&TIMx->CCMR1) + OFFSET_TAB_CCMRx[iChannel]));
    ...
    __STATIC_INLINE void LL_TIM_EnableBRK(TIM_TypeDef *TIMx)
    {
        ...
        /* Note: Any write operation to this bit takes a delay of 1 APB clock cycle to become
         * effective. */
    ...
    __STATIC_INLINE void LL_TIM_ConfigBRK(TIM_TypeDef *TIMx, uint32_t BreakPolarity)
    {
        ...
        /* Note: Any write operation to BKP bit takes a delay of 1 APB clock cycle to become
         * effective. */
        tmpreg = READ_REG(TIMx->BDTR);
        (void)(tmpreg);
    }
