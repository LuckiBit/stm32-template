...
#endif
#ifndef HAL_DCMI_MODULE_ENABLE
#define HAL_DCMI_MODULE_ENABLE 0
#endif
#ifndef HAL_DMA2D_MODULE_ENABLE
#define HAL_DMA2D_MODULE_ENABLE 0
#endif
#ifndef HAL_ETH_MODULE_ENABLE
#define HAL_ETH_MODULE_ENABLE 0
#endif
#ifndef HAL_ETH_LEGACY_MODULE_ENABLE
#define HAL_ETH_LEGACY_MODULE_ENABLE 0
#endif
...
#endif
#ifndef HAL_HASH_MODULE_ENABLE
#define HAL_HASH_MODULE_ENABLE 0
#endif
...
#endif
#ifndef HAL_LTDC_MODULE_ENABLE
#define HAL_LTDC_MODULE_ENABLE 0
#endif
#ifndef HAL_RNG_MODULE_ENABLE
#define HAL_RNG_MODULE_ENABLE 0
#endif
#ifndef HAL_RTC_MODULE_ENABLE
#define HAL_RTC_MODULE_ENABLE 0
#endif
#ifndef HAL_SAI_MODULE_ENABLE
#define HAL_SAI_MODULE_ENABLE 0
#endif
...
#define HAL_UART_MODULE_ENABLE 0
#endif
...
#endif
#ifndef HAL_SMBUS_MODULE_ENABLE
#define HAL_SMBUS_MODULE_ENABLE 0
#endif
...
#endif
#ifndef HAL_DSI_MODULE_ENABLE
#define HAL_DSI_MODULE_ENABLE 0
#endif
#ifndef HAL_QSPI_MODULE_ENABLE
#define HAL_QSPI_MODULE_ENABLE 0
#endif
#ifndef HAL_CEC_MODULE_ENABLE
#define HAL_CEC_MODULE_ENABLE 0
#endif
#ifndef HAL_FMPI2C_MODULE_ENABLE
#define HAL_FMPI2C_MODULE_ENABLE 0
#endif
#ifndef HAL_FMPSMBUS_MODULE_ENABLE
#define HAL_FMPSMBUS_MODULE_ENABLE 0
#endif
#ifndef HAL_SPDIFRX_MODULE_ENABLE
#define HAL_SPDIFRX_MODULE_ENABLE 0
#endif
#ifndef HAL_DFSDM_MODULE_ENABLE
#define HAL_DFSDM_MODULE_ENABLE 0
#endif
#ifndef HAL_LPTIM_MODULE_ENABLE
#define HAL_LPTIM_MODULE_ENABLE 0
#endif
...
#endif
#if(HAL_DCMI_MODULE_ENABLE != 0) && (HAL_DCMI_MODULE_ENABLE != 1)
#error "HAL_DCMI_MODULE_ENABLE must be 0 or 1"
#endif
#if(HAL_DMA2D_MODULE_ENABLE != 0) && (HAL_DMA2D_MODULE_ENABLE != 1)
#error "HAL_DMA2D_MODULE_ENABLE must be 0 or 1"
#endif
#if(HAL_ETH_MODULE_ENABLE != 0) && (HAL_ETH_MODULE_ENABLE != 1)
#error "HAL_ETH_MODULE_ENABLE must be 0 or 1"
#endif
#if(HAL_ETH_LEGACY_MODULE_ENABLE != 0) && (HAL_ETH_LEGACY_MODULE_ENABLE != 1)
#error "HAL_ETH_LEGACY_MODULE_ENABLE must be 0 or 1"
#endif
...
#endif
#if(HAL_HASH_MODULE_ENABLE != 0) && (HAL_HASH_MODULE_ENABLE != 1)
#error "HAL_HASH_MODULE_ENABLE must be 0 or 1"
#endif
...
#endif
#if(HAL_LTDC_MODULE_ENABLE != 0) && (HAL_LTDC_MODULE_ENABLE != 1)
#error "HAL_LTDC_MODULE_ENABLE must be 0 or 1"
#endif
#if(HAL_RNG_MODULE_ENABLE != 0) && (HAL_RNG_MODULE_ENABLE != 1)
#error "HAL_RNG_MODULE_ENABLE must be 0 or 1"
#endif
#if(HAL_RTC_MODULE_ENABLE != 0) && (HAL_RTC_MODULE_ENABLE != 1)
#error "HAL_RTC_MODULE_ENABLE must be 0 or 1"
#endif
#if(HAL_SAI_MODULE_ENABLE != 0) && (HAL_SAI_MODULE_ENABLE != 1)
#error "HAL_SAI_MODULE_ENABLE must be 0 or 1"
#endif
...
#endif
#if(HAL_SMBUS_MODULE_ENABLE != 0) && (HAL_SMBUS_MODULE_ENABLE != 1)
#error "HAL_SMBUS_MODULE_ENABLE must be 0 or 1"
#endif
...
#endif
#if(HAL_DSI_MODULE_ENABLE != 0) && (HAL_DSI_MODULE_ENABLE != 1)
#error "HAL_DSI_MODULE_ENABLE must be 0 or 1"
#endif
#if(HAL_QSPI_MODULE_ENABLE != 0) && (HAL_QSPI_MODULE_ENABLE != 1)
#error "HAL_QSPI_MODULE_ENABLE must be 0 or 1"
#endif
#if(HAL_CEC_MODULE_ENABLE != 0) && (HAL_CEC_MODULE_ENABLE != 1)
#error "HAL_CEC_MODULE_ENABLE must be 0 or 1"
#endif
#if(HAL_FMPI2C_MODULE_ENABLE != 0) && (HAL_FMPI2C_MODULE_ENABLE != 1)
#error "HAL_FMPI2C_MODULE_ENABLE must be 0 or 1"
#endif
#if(HAL_FMPSMBUS_MODULE_ENABLE != 0) && (HAL_FMPSMBUS_MODULE_ENABLE != 1)
#error "HAL_FMPSMBUS_MODULE_ENABLE must be 0 or 1"
#endif
#if(HAL_SPDIFRX_MODULE_ENABLE != 0) && (HAL_SPDIFRX_MODULE_ENABLE != 1)
#error "HAL_SPDIFRX_MODULE_ENABLE must be 0 or 1"
#endif
#if(HAL_DFSDM_MODULE_ENABLE != 0) && (HAL_DFSDM_MODULE_ENABLE != 1)
#error "HAL_DFSDM_MODULE_ENABLE must be 0 or 1"
#endif
#if(HAL_LPTIM_MODULE_ENABLE != 0) && (HAL_LPTIM_MODULE_ENABLE != 1)
#error "HAL_LPTIM_MODULE_ENABLE must be 0 or 1"
#endif
...
#endif
#if HAL_DCMI_MODULE_ENABLE
#define HAL_DCMI_MODULE_ENABLED
#endif
#if HAL_DMA2D_MODULE_ENABLE
#define HAL_DMA2D_MODULE_ENABLED
#endif
#if HAL_ETH_MODULE_ENABLE
#define HAL_ETH_MODULE_ENABLED
#endif
#if HAL_ETH_LEGACY_MODULE_ENABLE
...
#endif
#if HAL_LTDC_MODULE_ENABLE
#define HAL_LTDC_MODULE_ENABLED
#endif
#if HAL_RNG_MODULE_ENABLE
#define HAL_RNG_MODULE_ENABLED
#endif
#if HAL_RTC_MODULE_ENABLE
#define HAL_RTC_MODULE_ENABLED
#endif
#if HAL_SAI_MODULE_ENABLE
...
#endif
#if HAL_DSI_MODULE_ENABLE
#define HAL_DSI_MODULE_ENABLED
#endif
#if HAL_QSPI_MODULE_ENABLE
#define HAL_QSPI_MODULE_ENABLED
#endif
#if HAL_CEC_MODULE_ENABLE
#define HAL_CEC_MODULE_ENABLED
#endif
#if HAL_FMPI2C_MODULE_ENABLE
#define HAL_FMPI2C_MODULE_ENABLED
#endif
#if HAL_FMPSMBUS_MODULE_ENABLE
#define HAL_FMPSMBUS_MODULE_ENABLED
#endif
#if HAL_SPDIFRX_MODULE_ENABLE
#define HAL_SPDIFRX_MODULE_ENABLED
#endif
#if HAL_DFSDM_MODULE_ENABLE
#define HAL_DFSDM_MODULE_ENABLED
#endif
#if HAL_LPTIM_MODULE_ENABLE
