  ...
  ==============================================================================
     ...
     *** CAN HAL driver macros list ***
     ...
     [..]
      ...
      (+) __HAL_CAN_GET_IT_SOURCE: Check if the specified CAN interrupt source is enabled or
  disabled
...
HAL_StatusTypeDef HAL_CAN_Init(CAN_HandleTypeDef *hcan)
{
    ...
    if((hcan->Instance->MSR & CAN_MSR_INAK) == CAN_MSR_INAK)
    {
        ...
        MODIFY_REG(hcan->Instance->MCR,
                   CAN_MCR_TTCM | CAN_MCR_ABOM | CAN_MCR_AWUM | CAN_MCR_NART | CAN_MCR_RFLM |
                       CAN_MCR_TXFP,
                   tmp_mcr);

        /* Set the bit timing register */
        WRITE_REG(hcan->Instance->BTR,
                  (uint32_t)(hcan->Init.Mode | hcan->Init.SJW | hcan->Init.BS1 | hcan->Init.BS2 |
                                       ...
                                       CAN_FilterConfTypeDef *sFilterConfig)
{
    ...
    MODIFY_REG(hcan->Instance->FMR,
               CAN_FMR_CAN2SB,
               CAN_FMR_FINIT | (uint32_t)(sFilterConfig->BankNumber << 8U));
       ...
       ((hcan->Instance->TSR & CAN_TSR_TME2) == CAN_TSR_TME2))
    {
        ...
        if(hcan->pTxMsg->IDE == CAN_ID_STD)
        {
            ...
            hcan->Instance->sTxMailBox[transmitmailbox].TIR |=
                ((hcan->pTxMsg->StdId << CAN_TI0R_STID_Pos) | hcan->pTxMsg->RTR);
        }
        else
        {
            assert_param(IS_CAN_EXTID(hcan->pTxMsg->ExtId));
            hcan->Instance->sTxMailBox[transmitmailbox].TIR |=
                ((hcan->pTxMsg->ExtId << CAN_TI0R_EXID_Pos) | hcan->pTxMsg->IDE |
                 hcan->pTxMsg->RTR);
        }
        ...
        WRITE_REG(hcan->Instance->sTxMailBox[transmitmailbox].TDLR,
                  ((uint32_t)hcan->pTxMsg->Data[3] << CAN_TDL0R_DATA3_Pos) |
        ...
        WRITE_REG(hcan->Instance->sTxMailBox[transmitmailbox].TDHR,
                  ((uint32_t)hcan->pTxMsg->Data[7] << CAN_TDL0R_DATA3_Pos) |
...
HAL_StatusTypeDef HAL_CAN_Transmit_IT(CAN_HandleTypeDef *hcan)
{
       ...
       ((hcan->Instance->TSR & CAN_TSR_TME2) == CAN_TSR_TME2))
    {
        ...
        /* Set up the data field */
        WRITE_REG(hcan->Instance->sTxMailBox[transmitmailbox].TDLR,
                  ((uint32_t)hcan->pTxMsg->Data[3U] << CAN_TDL0R_DATA3_Pos) |
        ...
        WRITE_REG(hcan->Instance->sTxMailBox[transmitmailbox].TDHR,
                  ((uint32_t)hcan->pTxMsg->Data[7U] << CAN_TDL0R_DATA3_Pos) |
...
void HAL_CAN_IRQHandler(CAN_HandleTypeDef *hcan)
{
    ...
    if(__HAL_CAN_GET_IT_SOURCE(hcan, CAN_IT_TME))
    {
        ...
        if(tmp1 || tmp2 || tmp3)
        {
            ...
            SET_BIT(hcan->Instance->TSR,
                    CAN_TSR_RQCP0 | CAN_TSR_RQCP1 | CAN_TSR_RQCP2 | CAN_FLAG_TXOK0 |
                        CAN_FLAG_TXOK1 | CAN_FLAG_TXOK2);
        }
    }
    ...
    if(hcan->ErrorCode != HAL_CAN_ERROR_NONE)
    {
        ...
        __HAL_CAN_DISABLE_IT(hcan,
                             CAN_IT_EWG | CAN_IT_EPV | CAN_IT_BOF | CAN_IT_LEC | CAN_IT_ERR |
                                 CAN_IT_FMP0 | CAN_IT_FOV0 | CAN_IT_FMP1 | CAN_IT_FOV1 |
                                 CAN_IT_TME);
