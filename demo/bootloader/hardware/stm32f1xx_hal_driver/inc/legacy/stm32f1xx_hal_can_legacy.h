...
#define CAN_FLAG_RQCP0                                                                             \
    ((uint32_t)((TSR_REGISTER_INDEX << 8U) |                                                       \
                CAN_TSR_RQCP0_BIT_POSITION)) /*!< Request MailBox0 flag         */
#define CAN_FLAG_RQCP1                                                                             \
    ((uint32_t)((TSR_REGISTER_INDEX << 8U) |                                                       \
                CAN_TSR_RQCP1_BIT_POSITION)) /*!< Request MailBox1 flag         */
#define CAN_FLAG_RQCP2                                                                             \
    ((uint32_t)((TSR_REGISTER_INDEX << 8U) |                                                       \
                CAN_TSR_RQCP2_BIT_POSITION)) /*!< Request MailBox2 flag         */
#define CAN_FLAG_TXOK0                                                                             \
    ((uint32_t)((TSR_REGISTER_INDEX << 8U) |                                                       \
                CAN_TSR_TXOK0_BIT_POSITION)) /*!< Transmission OK MailBox0 flag */
#define CAN_FLAG_TXOK1                                                                             \
    ((uint32_t)((TSR_REGISTER_INDEX << 8U) |                                                       \
                CAN_TSR_TXOK1_BIT_POSITION)) /*!< Transmission OK MailBox1 flag */
#define CAN_FLAG_TXOK2                                                                             \
    ((uint32_t)((TSR_REGISTER_INDEX << 8U) |                                                       \
                CAN_TSR_TXOK2_BIT_POSITION)) /*!< Transmission OK MailBox2 flag */
#define CAN_FLAG_TME0                                                                              \
    ((uint32_t)((TSR_REGISTER_INDEX << 8U) |                                                       \
                CAN_TSR_TME0_BIT_POSITION)) /*!< Transmit mailbox 0 empty flag */
#define CAN_FLAG_TME1                                                                              \
    ((uint32_t)((TSR_REGISTER_INDEX << 8U) |                                                       \
                CAN_TSR_TME1_BIT_POSITION)) /*!< Transmit mailbox 0 empty flag */
#define CAN_FLAG_TME2                                                                              \
    ((uint32_t)((TSR_REGISTER_INDEX << 8U) |                                                       \
                CAN_TSR_TME2_BIT_POSITION)) /*!< Transmit mailbox 0 empty flag */

/* Receive Flags */
#define CAN_FLAG_FF0                                                                               \
    ((uint32_t)((RF0R_REGISTER_INDEX << 8U) | CAN_RF0R_FF0_BIT_POSITION)) /*!< FIFO 0 Full flag */
#define CAN_FLAG_FOV0                                                                              \
    ((uint32_t)((RF0R_REGISTER_INDEX << 8U) |                                                      \
                CAN_RF0R_FOV0_BIT_POSITION)) /*!< FIFO 0 Overrun flag */

#define CAN_FLAG_FF1                                                                               \
    ((uint32_t)((RF1R_REGISTER_INDEX << 8U) | CAN_RF1R_FF1_BIT_POSITION)) /*!< FIFO 1 Full flag */
#define CAN_FLAG_FOV1                                                                              \
    ((uint32_t)((RF1R_REGISTER_INDEX << 8U) |                                                      \
                CAN_RF1R_FOV1_BIT_POSITION)) /*!< FIFO 1 Overrun flag */

/* Operating Mode Flags */
#define CAN_FLAG_WKU                                                                               \
    ((uint32_t)((MSR_REGISTER_INDEX << 8U) | CAN_MSR_WKU_BIT_POSITION)) /*!< Wake up flag */
#define CAN_FLAG_SLAK                                                                              \
    ((uint32_t)((MSR_REGISTER_INDEX << 8U) |                                                       \
                CAN_MSR_SLAK_BIT_POSITION)) /*!< Sleep acknowledge flag */
#define CAN_FLAG_SLAKI                                                                             \
    ((uint32_t)((MSR_REGISTER_INDEX << 8U) |                                                       \
                CAN_MSR_SLAKI_BIT_POSITION)) /*!< Sleep acknowledge flag */
...
/* Error Flags */
#define CAN_FLAG_EWG                                                                               \
    ((uint32_t)((ESR_REGISTER_INDEX << 8U) | CAN_ESR_EWG_BIT_POSITION)) /*!< Error warning flag */
#define CAN_FLAG_EPV                                                                               \
    ((uint32_t)((ESR_REGISTER_INDEX << 8U) | CAN_ESR_EPV_BIT_POSITION)) /*!< Error passive flag */
#define CAN_FLAG_BOF                                                                               \
    ((uint32_t)((ESR_REGISTER_INDEX << 8U) | CAN_ESR_BOF_BIT_POSITION)) /*!< Bus-Off flag */
...
#define __HAL_CAN_TRANSMIT_STATUS(__HANDLE__, __TRANSMITMAILBOX__)                                 \
    (((__TRANSMITMAILBOX__) == CAN_TXMAILBOX_0)                                                    \
         ? ((((__HANDLE__)->Instance->TSR) & (CAN_TSR_RQCP0 | CAN_TSR_TME0)) ==                    \
            (CAN_TSR_RQCP0 | CAN_TSR_TME0))                                                        \
     : ((__TRANSMITMAILBOX__) == CAN_TXMAILBOX_1)                                                  \
         ? ((((__HANDLE__)->Instance->TSR) & (CAN_TSR_RQCP1 | CAN_TSR_TME1)) ==                    \
            (CAN_TSR_RQCP1 | CAN_TSR_TME1))                                                        \
         : ((((__HANDLE__)->Instance->TSR) & (CAN_TSR_RQCP2 | CAN_TSR_TME2)) ==                    \
