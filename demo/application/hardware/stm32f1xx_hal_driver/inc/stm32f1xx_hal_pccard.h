 ...
 */
...
#endif /* USE_HAL_PCCARD_REGISTER_CALLBACKS */
    {
        ...
        void (*MspInitCallback)(
            struct __PCCARD_HandleTypeDef *hpccard); /*!< PCCARD Msp Init callback              */
        void (*MspDeInitCallback)(
            struct __PCCARD_HandleTypeDef *hpccard); /*!< PCCARD Msp DeInit callback            */
...
#define __HAL_PCCARD_RESET_HANDLE_STATE(__HANDLE__) ((__HANDLE__)->State = HAL_PCCARD_STATE_RESET)
    ...
    HAL_StatusTypeDef
    HAL_PCCARD_Read_ID(PCCARD_HandleTypeDef *hpccard, uint8_t CompactFlash_ID[], uint8_t *pStatus);
...
#define ATA_STATUS_CMD_ALTERNATE                                                                   \
    ((uint8_t)0x0E) /* Alternate Status(read)/Command(write) register */
