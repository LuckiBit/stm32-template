...
#define IS_RTC_BKP(BKP)                                                                            \
    (((BKP) <= (uint32_t)RTC_BKP_DR10) ||                                                          \
     (((BKP) >= (uint32_t)RTC_BKP_DR11) && ((BKP) <= (uint32_t)RTC_BKP_DR42)))
#else
...
#define RTC_TAMPERTRIGGER_HIGHLEVEL                                                                \
    0x00000000U /*!< A low level on the TAMPER pin resets all data backup registers (if TPE bit is \
                   set) */
 ...
 * @retval None
 */
#define __HAL_RTC_SECOND_DISABLE_IT(__HANDLE__, __INTERRUPT__)                                     \
 ...
 * @retval None
 */
#define __HAL_RTC_SECOND_CLEAR_FLAG(__HANDLE__, __FLAG__)                                          \
 ...
 * @retval None
 */
#define __HAL_RTC_OVERFLOW_ENABLE_IT(__HANDLE__, __INTERRUPT__)                                    \
    SET_BIT((__HANDLE__)->Instance->CRH, (__INTERRUPT__))
 ...
 * @retval None
 */
#define __HAL_RTC_OVERFLOW_DISABLE_IT(__HANDLE__, __INTERRUPT__)                                   \
    CLEAR_BIT((__HANDLE__)->Instance->CRH, (__INTERRUPT__))
 ...
 * @retval None
 */
#define __HAL_RTC_OVERFLOW_CLEAR_FLAG(__HANDLE__, __FLAG__)                                        \
    ((__HANDLE__)->Instance->CRL) = ~(__FLAG__)
